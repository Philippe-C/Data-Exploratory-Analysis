...
png('plot1.png')
plot( aggregatedTotalByYear$year, aggregatedTotalByYear$Emissions, type="l", col="red", xlab="Years", ylab=expression('Total PM'[2.5]*' emission'),main=expression('Total PM'[2.5]*' emissions in the US from 1999 to 2008'))
