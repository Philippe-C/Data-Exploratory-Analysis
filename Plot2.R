...
png('Plot2.png')
barplot(height=aggregatedTotalByYear$Emissions, names.arg=aggregatedTotalByYear$year, xlab="Years", ylab=expression('total PM'[2.5]*' emission (tons)'),main=expression('Total PM'[2.5]*' emission in Baltimore from 1999-2008'))
